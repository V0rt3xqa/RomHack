...
extern const u8 BattleScript_MoveUsedIsDrowsy[];
...
extern const u8 BattleScript_TargetFoughtOffDrowsiness[];
...
extern const u8 BattleScript_BerryCureDrsEnd2[];
extern const u8 BattleScript_BerryCureDrsRet[];
